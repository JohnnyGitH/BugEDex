 ...
 */
import { Migration } from '@angular/cdk/schematics/update-tool/migration';
import { ValueOfChanges, VersionChanges } from '@angular/cdk/schematics/update-tool/version-changes';
import { AttributeSelectorUpgradeData, ClassNameUpgradeData, ConstructorChecksUpgradeData, CssSelectorUpgradeData, ElementSelectorUpgradeData, InputNameUpgradeData, MethodCallUpgradeData, OutputNameUpgradeData, PropertyNameUpgradeData, SymbolRemovalUpgradeData } from '@angular/cdk/schematics/ng-update/data';
