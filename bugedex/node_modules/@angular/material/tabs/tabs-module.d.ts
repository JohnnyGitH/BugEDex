...
import * as i1 from "@angular/material/tabs/tab-group";
import * as i2 from "@angular/material/tabs/tab-label";
import * as i3 from "@angular/material/tabs/tab";
import * as i4 from "@angular/material/tabs/ink-bar";
import * as i5 from "@angular/material/tabs/tab-label-wrapper";
import * as i6 from "@angular/material/tabs/tab-nav-bar/tab-nav-bar";
import * as i7 from "@angular/material/tabs/tab-body";
import * as i8 from "@angular/material/tabs/tab-header";
import * as i9 from "@angular/material/tabs/tab-content";
