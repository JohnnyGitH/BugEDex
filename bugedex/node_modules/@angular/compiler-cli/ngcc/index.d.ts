...
import { AsyncNgccOptions, SyncNgccOptions } from '@angular/compiler-cli/ngcc/src/ngcc_options';
export { ConsoleLogger, Logger, LogLevel } from '@angular/compiler-cli/src/ngtsc/logging';
export { AsyncNgccOptions, clearTsConfigCache, NgccOptions, SyncNgccOptions } from '@angular/compiler-cli/ngcc/src/ngcc_options';
export { PathMappings } from '@angular/compiler-cli/ngcc/src/path_mappings';
