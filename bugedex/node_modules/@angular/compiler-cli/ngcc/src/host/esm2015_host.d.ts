...
import { ClassDeclaration, ClassMember, ClassMemberKind, CtorParameter, Declaration, DeclarationNode, Decorator, EnumMember, TypeScriptReflectionHost } from '@angular/compiler-cli/src/ngtsc/reflection';
import { BundleProgram } from '@angular/compiler-cli/ngcc/src/packages/bundle_program';
import { NgccClassSymbol, NgccReflectionHost } from '@angular/compiler-cli/ngcc/src/host/ngcc_host';
