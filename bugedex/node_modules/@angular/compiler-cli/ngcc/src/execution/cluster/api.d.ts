...
import { PackageJsonChange } from '@angular/compiler-cli/ngcc/src/writing/package_json_updater';
import { Task, TaskProcessingOutcome } from '@angular/compiler-cli/ngcc/src/execution/tasks/api';
