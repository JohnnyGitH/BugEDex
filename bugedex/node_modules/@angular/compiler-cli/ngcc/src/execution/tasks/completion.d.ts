 ...
 */
import { PathManipulation, ReadonlyFileSystem } from '@angular/compiler-cli/src/ngtsc/file_system';
import { Logger } from '@angular/compiler-cli/src/ngtsc/logging';
import { PackageJsonUpdater } from '@angular/compiler-cli/ngcc/src/writing/package_json_updater';
import { Task, TaskCompletedCallback, TaskProcessingOutcome, TaskQueue } from '@angular/compiler-cli/ngcc/src/execution/tasks/api';
/**
