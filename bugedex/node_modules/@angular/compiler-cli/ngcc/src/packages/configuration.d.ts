...
import { AbsoluteFsPath, PathManipulation, ReadonlyFileSystem } from '@angular/compiler-cli/src/ngtsc/file_system';
import { PackageJsonFormatPropertiesMap } from '@angular/compiler-cli/ngcc/src/packages/entry_point';
/**
