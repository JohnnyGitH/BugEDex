...
import { AbsoluteFsPath, FileSystem, NgtscCompilerHost } from '@angular/compiler-cli/src/ngtsc/file_system';
import { EntryPointFileCache } from '@angular/compiler-cli/ngcc/src/packages/source_file_cache';
/**
