...
import { ReadonlyFileSystem } from '@angular/compiler-cli/src/ngtsc/file_system';
import { ModuleResolver, PrivateExportAliasingHost, ReferenceEmitter } from '@angular/compiler-cli/src/ngtsc/imports';
import { SemanticSymbol } from '@angular/compiler-cli/src/ngtsc/incremental/semantic_graph';
import { CompoundMetadataReader, CompoundMetadataRegistry, DtsMetadataReader, InjectableClassRegistry, LocalMetadataRegistry } from '@angular/compiler-cli/src/ngtsc/metadata';
import { PartialEvaluator } from '@angular/compiler-cli/src/ngtsc/partial_evaluator';
import { LocalModuleScopeRegistry, MetadataDtsModuleScopeResolver, TypeCheckScopeRegistry } from '@angular/compiler-cli/src/ngtsc/scope';
...
import { Migration } from '@angular/compiler-cli/ngcc/src/migrations/migration';
import { EntryPointBundle } from '@angular/compiler-cli/ngcc/src/packages/entry_point_bundle';
import { NgccTraitCompiler } from '@angular/compiler-cli/ngcc/src/analysis/ngcc_trait_compiler';
import { CompiledFile, DecorationAnalyses } from '@angular/compiler-cli/ngcc/src/analysis/types';
/**
