...
import { MapAndPath } from '@angular/compiler-cli/src/ngtsc/sourcemaps/src/raw_source_map';
import { SourceFile } from '@angular/compiler-cli/src/ngtsc/sourcemaps/src/source_file';
/**
