...
import { ComponentScopeReader } from '@angular/compiler-cli/src/ngtsc/scope';
import { ElementSymbol, ReferenceSymbol, Symbol, TemplateSymbol, VariableSymbol } from '@angular/compiler-cli/src/ngtsc/typecheck/api';
import { TemplateData } from '@angular/compiler-cli/src/ngtsc/typecheck/src/context';
/**
