...
import { TemplateDiagnostic, TemplateTypeChecker } from '@angular/compiler-cli/src/ngtsc/typecheck/api';
import { ExtendedTemplateChecker, TemplateCheck } from '@angular/compiler-cli/src/ngtsc/typecheck/extended/api';
