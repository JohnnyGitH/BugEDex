...
import { NgTemplateDiagnostic } from '@angular/compiler-cli/src/ngtsc/typecheck/api';
import { TemplateCheckWithVisitor, TemplateContext } from '@angular/compiler-cli/src/ngtsc/typecheck/extended/api';
/**
