...
import { CycleAnalyzer, CycleHandlingStrategy } from '@angular/compiler-cli/src/ngtsc/cycles';
import { ModuleResolver, Reference, ReferenceEmitter } from '@angular/compiler-cli/src/ngtsc/imports';
import { DependencyTracker } from '@angular/compiler-cli/src/ngtsc/incremental/api';
import { SemanticDepGraphUpdater, SemanticReference, SemanticSymbol } from '@angular/compiler-cli/src/ngtsc/incremental/semantic_graph';
import { IndexingContext } from '@angular/compiler-cli/src/ngtsc/indexer';
import { ClassPropertyMapping, ComponentResources, DirectiveTypeCheckMeta, InjectableClassRegistry, MetadataReader, MetadataRegistry, ResourceRegistry } from '@angular/compiler-cli/src/ngtsc/metadata';
...
import { ComponentScopeReader, LocalModuleScopeRegistry, TypeCheckScopeRegistry } from '@angular/compiler-cli/src/ngtsc/scope';
import { AnalysisOutput, CompileResult, DecoratorHandler, DetectResult, HandlerFlags, HandlerPrecedence, ResolveResult } from '@angular/compiler-cli/src/ngtsc/transform';
import { TemplateSourceMapping, TypeCheckContext } from '@angular/compiler-cli/src/ngtsc/typecheck/api';
...
import { ResourceLoader } from '@angular/compiler-cli/src/ngtsc/annotations/src/api';
import { DirectiveSymbol } from '@angular/compiler-cli/src/ngtsc/annotations/src/directive';
/**
