...
import { SemanticReference, SemanticSymbol } from '@angular/compiler-cli/src/ngtsc/incremental/semantic_graph';
import { InjectableClassRegistry, MetadataReader, MetadataRegistry } from '@angular/compiler-cli/src/ngtsc/metadata';
