...
import { SemanticDepGraphUpdater, SemanticSymbol, SemanticTypeParameter } from '@angular/compiler-cli/src/ngtsc/incremental/semantic_graph';
import { ClassPropertyMapping, DirectiveTypeCheckMeta, InjectableClassRegistry, MetadataReader, MetadataRegistry } from '@angular/compiler-cli/src/ngtsc/metadata';
