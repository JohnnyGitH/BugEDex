...
import { ClassDeclaration, CtorParameter, Decorator, Import, ImportedTypeValueReference, LocalTypeValueReference, ReflectionHost, TypeValueReference, UnavailableValue } from '@angular/compiler-cli/src/ngtsc/reflection';
import { DeclarationData } from '@angular/compiler-cli/src/ngtsc/scope';
