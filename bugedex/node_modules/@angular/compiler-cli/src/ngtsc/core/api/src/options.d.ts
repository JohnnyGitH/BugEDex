...
import { BazelAndG3Options, I18nOptions, LegacyNgcOptions, MiscOptions, NgcCompatibilityOptions, StrictTemplateOptions, TargetOptions } from '@angular/compiler-cli/src/ngtsc/core/api/src/public_options';
/**
