...
import { LinkerOptions } from '@angular/compiler-cli/linker/src/file_linker/linker_options';
import { ConfigAPI, PluginObj } from '@angular/compiler-cli/linker/babel/src/babel_core';
/**
