...
import { PluginObj } from '@angular/compiler-cli/linker/babel/src/babel_core';
import { LinkerPluginOptions } from '@angular/compiler-cli/linker/babel/src/linker_plugin_options';
/**
