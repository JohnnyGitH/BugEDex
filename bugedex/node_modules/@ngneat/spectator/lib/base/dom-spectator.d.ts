...
import { Token } from '@ngneat/spectator/lib/token';
import { DOMSelector } from '@ngneat/spectator/lib/dom-selectors';
import { SpectatorElement, EventEmitterType, KeysMatching, KeyboardEventOptions } from '@ngneat/spectator/lib/types';
import { SpyObject } from '@ngneat/spectator/lib/mock';
import { BaseSpectator } from '@ngneat/spectator/lib/base/base-spectator';
/**
 * @internal
 */
