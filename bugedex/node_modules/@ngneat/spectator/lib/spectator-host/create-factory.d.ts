...
import { SpectatorOverrides } from '@ngneat/spectator/lib/spectator/create-factory';
import { HostComponent } from '@ngneat/spectator/lib/spectator-host/host-component';
import { SpectatorHostOptions } from '@ngneat/spectator/lib/spectator-host/options';
import { SpectatorHost } from '@ngneat/spectator/lib/spectator-host/spectator-host';
/**
 * @publicApi
 */
