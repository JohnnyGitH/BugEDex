...
import { SimpleChange, ChangeDetectorRef, DebugElement, ElementRef, NO_ERRORS_SCHEMA, Component, NgModule, NgZone } from '@angular/core';
...
const byTextContent = (matcher, options) => {
    ...
    const getTextContent = (elem) => { var _a; return normalizer((_a = elem === null || elem === void 0 ? void 0 : elem.textContent) !== null && _a !== void 0 ? _a : ''); };
 ...
 */
const toHaveText = comparator((el, expected, exact = false) => hasSameText(el, expected, exact));
const toHaveExactText = comparator((el, expected) => hasSameText(el, expected, true));
...
function initialModule(options) {
    ...
    return {
        ...
        teardown: Object.assign({}, (globals.teardown || options.teardown)),
    };
}
...
HostComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.2", ngImport: i0, type: HostComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
HostComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.0.2", type: HostComponent, selector: "ng-component", ngImport: i0, template: '', isInline: true });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.0.2", ngImport: i0, type: HostComponent, decorators: [{
            type: Component,
            args: [{
                    template: ''
                }]
...
HostModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.2", ngImport: i0, type: HostModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
HostModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.0.2", ngImport: i0, type: HostModule, declarations: [HostComponent] });
HostModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.0.2", ngImport: i0, type: HostModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.0.2", ngImport: i0, type: HostModule, decorators: [{
            type: NgModule,
            args: [{
...
const defaultRoutingOptions = Object.assign(Object.assign({}, getSpectatorDefaultOptions()), { params: {}, queryParams: {}, data: {}, fragment: null, stubsEnabled: true, routes: [], url: [], root: null, parent: null, children: null, firstChild: null });
/**
 * @internal
 */
